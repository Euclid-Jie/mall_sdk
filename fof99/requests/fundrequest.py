...
class FundPrice(BaseRequest):
    ...
    def set_params(
        self, reg_code, start_date=None, end_date=None, order_by="price_date", order=1
    ):
        self["reg_code"] = reg_code
        if start_date:
...
class PersonalFundPrice(BaseRequest):
    ...
    def set_params(
        self, fid, start_date=None, end_date=None, order_by="price_date", order=1
    ):
        self["fid"] = fid
        if start_date:
            self["start_date"] = start_date
...
class MonitorLogList(BaseRequest):
    ...
    def set_params(
        self, start_date=None, end_date=None, order_by="trigger_date", order=1
    ):
        if start_date:
            self["start_date"] = start_date
        if end_date:
